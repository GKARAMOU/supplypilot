...
[![Live demo](https://img.shields.io/badge/demo-live-0d5c46)](https://gkaramou.github.io/supplypilot/)
...
**[Open the live interactive demo](https://gkaramou.github.io/supplypilot/)**
...
| Quality | JUnit 5, MockMvc, Vitest, Testing Library, ESLint, JaCoCo |
...
Without `VITE_API_URL`, the dashboard uses seeded in-browser data so the
...
The CI pipeline runs frontend lint, component tests and production builds, backend integration tests
